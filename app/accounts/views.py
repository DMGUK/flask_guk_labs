...
def account():
    ...
    if update_account_form.validate_on_submit():
        ...
        return redirect(url_for('accounts.account', form=update_account_form))
    ...
    return render_template('account.html', user_id=user_id, update_account_form=update_account_form, change_password_form=change_password_form)
